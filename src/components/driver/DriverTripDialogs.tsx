    ...
    <>
        ...
        >
          ...
          >
            <Text style={styles.dialogTitle}>
              {t("driver.tripDialogs.startTrip.title")}
            </Text>
            <Text style={styles.dialogText}>
              {t("driver.tripDialogs.startTrip.message", { clientName })}
            </Text>
            <View style={styles.dialogButtonsContainer}>
              ...
              >
                <Text style={styles.dialogCancelButtonText}>
                  {t("driver.tripDialogs.buttons.cancelAction")}
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
      ...
      <Modal visible={showWaiting} transparent animationType="fade">
        ...
        >
          ...
          >
            <Text style={styles.dialogTitle}>
              {t("driver.tripDialogs.waiting.title")}
            </Text>
            <Text style={styles.dialogText}>
              {t("driver.tripDialogs.waiting.message", { clientName })}
            </Text>
            <View style={styles.dialogButtonsContainer}>
              <TouchableOpacity
                style={styles.dialogCancelButton}
      ...
      <Modal visible={showEmpty} transparent animationType="fade">
        ...
        >
          ...
          >
            <Text style={styles.dialogTitle}>
              {t("driver.tripDialogs.beginTrip.title")}
            </Text>
            <Text style={styles.dialogText}>
              {t("driver.tripDialogs.beginTrip.message", { clientName })}
            </Text>
            <View style={styles.dialogButtonsContainer}>
              <TouchableOpacity
                style={styles.dialogCancelButton}
      ...
      <Modal visible={showCancel} transparent animationType="fade">
        ...
        >
          ...
          >
            <Text style={styles.dialogTitle}>
              {t("driver.tripDialogs.cancelTrip.title")}
            </Text>
            <Text style={styles.dialogText}>
              {t("driver.tripDialogs.cancelTrip.message", { clientName })}
            </Text>
            <View style={styles.dialogButtonsContainer}>
              <TouchableOpacity
                style={styles.dialogCancelButton}
      ...
      <Modal visible={showEnd} transparent animationType="fade">
        ...
        >
          ...
          >
            <Text style={styles.dialogTitle}>
              {t("driver.tripDialogs.endTrip.title")}
            </Text>
            <Text style={styles.dialogText}>
              {t("driver.tripDialogs.endTrip.message", { clientName })}
            </Text>
            <View style={styles.dialogButtonsContainer}>
              <TouchableOpacity
                style={styles.dialogCancelButton}
      ...
      <Modal visible={showEmergency} transparent animationType="fade">
        ...
        >
          ...
          >
            <Text style={styles.dialogTitle}>
              {t("driver.tripDialogs.emergency.title")}
            </Text>
            <Text style={styles.dialogText}>
              {t("driver.tripDialogs.emergency.message")}
            </Text>
            <View style={styles.dialogButtonsContainer}>
              <TouchableOpacity
              ...
              >
                <Text style={styles.emergencyButtonText}>
                  {t("driver.tripDialogs.emergency.stop")}
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
              ...
              >
                <Text style={styles.emergencyButtonText}>
                  {t("driver.tripDialogs.emergency.end")}
                </Text>
              </TouchableOpacity>
            </View>
          </TouchableOpacity>
      ...
      <Modal visible={showStop} transparent animationType="fade">
        ...
        >
          ...
          >
            <Text style={styles.dialogTitle}>
              {t("driver.tripDialogs.stopTrip.title")}
            </Text>
            <Text style={styles.dialogText}>
              {t("driver.tripDialogs.stopTrip.message")}
            </Text>
            <View style={styles.dialogButtonsContainer}>
              <TouchableOpacity
                style={styles.dialogCancelButton}
      ...
      <Modal visible={showForceEnd} transparent animationType="fade">
        ...
        >
          ...
          >
            <Text style={styles.dialogTitle}>
              {t("driver.tripDialogs.forceEndTrip.title")}
            </Text>
            <Text style={styles.dialogText}>
              {t("driver.tripDialogs.forceEndTrip.message")}
            </Text>
            <View style={styles.dialogButtonsContainer}>
              <TouchableOpacity
                style={styles.dialogCancelButton}
      ...
      <Modal visible={showContinue} transparent animationType="fade">
        ...
        >
          ...
          >
            <Text style={styles.dialogTitle}>
              {t("driver.tripDialogs.continueTrip.title")}
            </Text>
            <Text style={styles.dialogText}>
              {t("driver.tripDialogs.continueTrip.message")}
            </Text>
            <View style={styles.dialogButtonsContainer}>
              <TouchableOpacity
                style={styles.dialogCancelButton}
          ...
          <View style={styles.commentContainer}>
            <Text style={styles.commentLabel}>
              {emergencyActionsUsed
                ? t("common.rating.commentRequired")
                : t("common.rating.commentLabel")}
            </Text>
            <TextInput
