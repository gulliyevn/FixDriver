...
interface DriverFamilyMemberViewModeProps {
  member: FamilyMember;
...
const DriverFamilyMemberViewMode: React.FC<DriverFamilyMemberViewModeProps> = ({
  member,
  phoneVerified,
  onStartEditing,
  onVerifyPhone,
...
export default DriverFamilyMemberViewMode; 