...
import { FamilyMemberItemProps, FamilyMember } from '../../types/driver/DriverFamily';
import { calculateAge } from '../../utils/profileHelpers';
import DriverFamilyMemberEditMode from './DriverFamilyMemberEditMode';
import DriverFamilyMemberViewMode from './DriverFamilyMemberViewMode';



const DriverFamilyMemberItem: React.FC<FamilyMemberItemProps> = ({
  member,
  isExpanded,
  isEditing,
  phoneVerified,
...
export default DriverFamilyMemberItem; 