...
import { DriverAddFamilyModalStyles as styles, getDriverAddFamilyModalColors } from '../../styles/components/driver/DriverAddFamilyModal.styles';
...
interface DriverAddFamilyModalProps {
  visible: boolean;
...
const DriverAddFamilyModal: React.FC<DriverAddFamilyModalProps> = ({
  visible,
  newFamilyMember,
  setNewFamilyMember,
  onClose,
  ...
  const { t } = useLanguage();
  const dynamicStyles = getDriverAddFamilyModalColors(isDark);
...
export default DriverAddFamilyModal; 