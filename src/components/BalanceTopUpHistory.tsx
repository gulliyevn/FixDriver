...
const BalanceTopUpHistory: React.FC<BalanceTopUpHistoryProps> = ({
  maxItems = 5,
}) => {
        ...
        {isDriver && (
          <TouchableOpacity
            ...
            style={[
              ...
              {
                backgroundColor: showWithdrawals
                  ? SWITCH_COLORS.active
                  : SWITCH_COLORS.inactive,
              },
            ]}
          >
            <Animated.View
            ...
            <View
              style={[
                styles.switchIcon,
                { opacity: showWithdrawals ? 0.5 : 1 },
              ]}
            >
              <Ionicons name="add-circle" style={styles.switchIconImage} />
            </View>
            <View
              style={[
                styles.switchIcon,
                { opacity: showWithdrawals ? 1 : 0.5 },
              ]}
            >
              <Ionicons name="card" style={styles.switchIconImage} />
            </View>
          </TouchableOpacity>
        )}
      </View>
          ...
          return (
            ...
            >
                ...
                <View style={styles.transactionDetails}>
                  <Text
                    style={[
                      ...
                      dynamicStyles.transactionTitle,
                    ]}
                  >
                    {t(
                      isWithdraw
                        ? "client.balance.withdrawal"
                        : "client.balance.balanceTopUp",
                    )}
                  </Text>
                  <Text
                    style={[
                      styles.transactionDate,
                      dynamicStyles.transactionDate,
                    ]}
                  >
                    {formatDate(
              ...
              <View style={styles.transactionRight}>
                ...
                >
                  {isWithdraw ? "-" : "+"}
                  {Math.abs(transaction.amount)} AFc
                </Text>
