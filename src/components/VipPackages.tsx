...
import {
  VipPackagesStyles,
  getVipPackagesColors,
  getPackageCardColors,
} from "../styles/components/VipPackages.styles";
...
const VipPackages: React.FC<VipPackagesProps> = ({
  ...
  const renderFeatureValue = (
    ...
    if (typeof value === "boolean") {
      return value ? (
        ...
        <View
          style={[
            VipPackagesStyles.iconContainer,
            VipPackagesStyles.crossContainer,
          ]}
        >
  ...
  const getFeatureIcon = (featureIndex: number) => {
    return (
      PACKAGE_FEATURE_ICONS[featureIndex] || {
  ...
  return (
    <View style={VipPackagesStyles.container}>
      ...
      <View
        style={[
          VipPackagesStyles.periodSwitchContainer,
          dynamicStyles.periodSwitchContainer,
        ]}
      >
        <TouchableOpacity
          ...
          <Animated.View
            style={[
              ...
              selectedPeriod !== "month" &&
                VipPackagesStyles.periodButtonInactive,
              selectedPeriod === "month" && {
          ...
          >
            <Text
              style={[
                ...
                {
                  color:
                    selectedPeriod === "month" ? "#fff" : currentColors.text,
                },
              ]}
            >
            ...
            <View style={VipPackagesStyles.yearButtonContent}>
              <Text
                style={[
                  ...
                  {
                    color:
                      selectedPeriod === "year" ? "#fff" : currentColors.text,
                  },
                ]}
              >
              ...
              <TouchableOpacity
                style={[
                  ...
                  isPackageActive(pkg.id) &&
                    VipPackagesStyles.selectedPackageCard,
                ]}
                onPress={() =>
                  onSelectPackage(pkg.id, pkg.price, selectedPeriod)
                }
                activeOpacity={0.8}
              >
                <View style={VipPackagesStyles.packageHeader}>
                  ...
                  >
                    ...
                    <Text
                      style={[
                        VipPackagesStyles.packageTitle,
                        dynamicStyles.packageTitle,
                      ]}
                    >
                      {pkg.name}
                    </Text>
                  ...
                  {isPackageActive(pkg.id) && (
                    <View style={VipPackagesStyles.selectedIndicator}>
                      <Ionicons
                        name="checkmark-circle"
                        size={ICON_SIZES.SELECTED_INDICATOR}
                ...
                <View style={VipPackagesStyles.featuresContainer}>
                  {packageFeatures.map((feature, featureIndex) => {
                    ...
                    const isLastRow =
                      featureIndex === packageFeatures.length - 1;
                    return (
                      <View
                        key={featureIndex}
                        style={[
                      ...
                      >
                        <View style={VipPackagesStyles.featureNameContainer}>
                          <View
                            style={[
                              VipPackagesStyles.iconWrapper,
                              {
                                backgroundColor:
                                  (featureIcon.color || "#6B7280") + "15",
                              },
                            ]}
                          >
                            <Ionicons
                              name={
                                (featureIcon.name as keyof typeof Ionicons.glyphMap) ||
                                "ellipse-outline"
                              }
