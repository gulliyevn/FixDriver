...
const FamilyMemberEditMode: React.FC<FamilyMemberEditModeProps> = ({
  ...
  const handleDelete = () => {
    Alert.alert(t("common.confirmation"), t("profile.family.confirmDelete"), [
      { text: t("common.cancel"), style: "cancel" },
    ...
    <View>
      ...
      <View style={styles.fieldContainer}>
        ...
        <TextInput
          ...
          onChangeText={(text) =>
            setEditingData({ ...editingData, name: text })
          }
      ...
      <View style={styles.fieldContainer}>
        ...
        <TextInput
          ...
          onChangeText={(text) =>
            setEditingData({ ...editingData, surname: text })
          }
        ...
        <View style={styles.typeDropdownContainer}>
          ...
          >
            <Text style={styles.typeDropdownText}>
              {editingData.type
                ? familyTypes.find((t) => t.key === editingData.type)?.label
                  ...
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      (editingData.type || member.type) === type.key &&
                        styles.typeDropdownItemSelected,
                    ]}
                    onPress={() => {
                  ...
                  >
                    <Text
                      style={[
                        ...
                        (editingData.type || member.type) === type.key &&
                          styles.typeDropdownItemTextSelected,
                      ]}
                    >
                      {type.label}
                    </Text>
      ...
      <View style={styles.fieldContainer}>
        ...
        <View style={styles.fieldDisplay}>
          <DatePicker
            ...
            onChange={(date) =>
              setEditingData({ ...editingData, birthDate: date })
            }
