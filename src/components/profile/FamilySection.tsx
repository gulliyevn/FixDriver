...
import {
  FamilySectionStyles as styles,
  getFamilySectionColors,
} from "../../styles/components/profile/FamilySection.styles";
    ...
    <View style={styles.familySection}>
      ...
      {familyMembers.map((member) => (
        <FamilyMemberItem
          ...
          phoneVerified={
            familyPhoneVerification[member.id] || member.phoneVerified || false
          }
