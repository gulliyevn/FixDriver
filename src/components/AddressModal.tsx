...
const AddressModal: React.FC<AddressModalProps> = ({
  ...
  const { geocodeFromCoordinates, verifyAddress: verifyAddressRemote } =
      ...
      >
        <View style={[styles.modalHeader, dynamicStyles.modalHeader]}>
          ...
          <Text style={[styles.modalTitle, dynamicStyles.modalTitle]}>
            {mode === "add"
              ? t("profile.residence.modal.addTitle")
              : t("profile.residence.modal.editTitle")}
          </Text>
          <TouchableOpacity
            onPress={handleSave}
            style={[
        ...
        <AddressForm
          ...
          labels={{
            ...
            categoryPlaceholder: t(
              "profile.residence.modal.categoryPlaceholder",
            ),
