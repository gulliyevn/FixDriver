...
export const usePaymentHistory = (): UsePaymentHistoryResult => {
  ...
  const [stats, setStats] = useState<PaymentStats>(
    PaymentHistoryService.getEmptyStats(),
  );
  ...
  const availableFilters = useMemo(
    () => ({
      types: [
        {
          key: "all",
          label: "client.paymentHistory.filter.allTypes",
          icon: "list",
        },
        {
          key: "trip",
          label: "client.paymentHistory.filter.trips",
          icon: "car",
        },
        {
          key: "topup",
          label: "client.paymentHistory.filter.topups",
          icon: "add-circle",
        },
        {
          key: "refund",
          label: "client.paymentHistory.filter.refunds",
          icon: "refresh-circle",
        },
        {
          key: "fee",
          label: "client.paymentHistory.filter.fees",
          icon: "card",
        },
        {
          key: "package_purchase",
          label: "client.paymentHistory.filter.packages",
          icon: "cube",
        },
        {
          key: "subscription_renewal",
          label: "client.paymentHistory.filter.subscriptions",
          icon: "refresh",
        },
        ...(userRole === "driver"
          ? [
              {
                key: "withdrawal",
                label: "driver.balance.transactions.withdrawal",
                icon: "cash",
              },
              {
                key: "earnings",
                label: "driver.balance.transactions.earnings",
                icon: "trending-up",
              },
            ]
          : []),
      ...
      statuses: [
        {
          key: "all",
          label: "client.paymentHistory.filter.allStatuses",
          icon: "checkmark-circle",
        },
        {
          key: "completed",
          label: "client.paymentHistory.status.completed",
          icon: "checkmark-circle",
        },
        {
          key: "pending",
          label: "client.paymentHistory.status.pending",
          icon: "time",
        },
        {
          key: "failed",
          label: "client.paymentHistory.status.failed",
          icon: "close-circle",
        },
      ],
      dateRanges: [
        {
          key: "all",
          label: "client.paymentHistory.filter.allTime",
          icon: "calendar",
        },
        {
          key: "today",
          label: "client.paymentHistory.filter.today",
          icon: "today",
        },
        {
          key: "week",
          label: "client.paymentHistory.filter.thisWeek",
          icon: "calendar-outline",
        },
        {
          key: "month",
          label: "client.paymentHistory.filter.thisMonth",
          icon: "calendar",
        },
        {
          key: "year",
          label: "client.paymentHistory.filter.thisYear",
          icon: "calendar",
        },
      ],
    }),
  ...
  const loadStats = useCallback(async () => {
    ...
    try {
      const newStats = await PaymentHistoryService.getPaymentStats(
        user.id,
        userRole,
      );
      setStats(newStats);
