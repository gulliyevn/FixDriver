...
export const addFamilyMember = (clientId: string, member: Omit<FamilyMember, 'id'>): FamilyMember => {
...
export const updateFamilyMember = (clientId: string, memberId: string, updates: Partial<FamilyMember>): FamilyMember | null => {
  const members = familyMembersMock[clientId];
...
export const deleteFamilyMember = (clientId: string, memberId: string): boolean => {
  const members = familyMembersMock[clientId];
