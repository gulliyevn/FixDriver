...
export const DATABASE_CONFIG = {
  ...
  production: {
    ...
    connectionString:
      process.env.DB_CONNECTION_STRING || "your-connection-string",
  },

  // Настройки API
  api: {
    baseUrl:
      process.env.EXPO_PUBLIC_API_BASE_URL || "https://api.fixdrive.com/api",
  ...
  services: {
    maps: {
      googleMapsApiKey:
        process.env.EXPO_PUBLIC_GOOGLE_MAPS_API_KEY || "your-google-maps-key",
      maptilerApiKey:
        process.env.EXPO_PUBLIC_MAPTILER_API_KEY || "your-maptiler-key",
    },
    payment: {
    ...
    traffic: {
      ...
      openweatherApiKey:
        process.env.OPENWEATHER_API_KEY || "your-openweather-key",
    },
  },
};
