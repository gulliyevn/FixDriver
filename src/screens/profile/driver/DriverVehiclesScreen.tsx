...
import {
  DriverVehiclesScreenStyles as styles,
  getDriverVehiclesScreenColors,
} from "../../../styles/screens/profile/driver/DriverVehiclesScreen.styles";
          ...
          <View style={styles.form}>
            <View style={styles.inputContainer}>
              <Text style={[styles.label, dynamicStyles.label]}>
                {t("profile.vehicles.vehicleNumber")}{" "}
