...
interface CustomizationModalProps {
  ...
  onTempCustomizedDaysChange: (days: {
      ...
      >
        ...
        >
          ...
          >
            {weekDays.map((day) => {
              ...
              if (
                ...
                day.key === selectedDays[0] ||
                tempCustomizedDays[day.key]
              )
                return null;
              ...
              return (
                <TouchableOpacity
                  ...
                  onPress={() => {
                    if (isSelected) {
                      onSelectedCustomDaysChange(
                        selectedCustomDays.filter((d) => d !== day.key),
                      );
                    } else {
                      onSelectedCustomDaysChange([
                        ...selectedCustomDays,
          ...
          {validationError && (
            ...
            >
              <Text
                style={{ color: "#D32F2F", fontSize: 14, textAlign: "center" }}
              >
