      ...
      try {
        ...
        if (sessionData?.timeScheduleData) {
          ...
          if (sessionData.timeScheduleData.fixedTimes) {
            state.setTimes({
              ...state.times,
              fixed: sessionData.timeScheduleData.fixedTimes,
            });
          }
          if (sessionData.timeScheduleData.weekdayTimes) {
            state.setTimes({
              ...state.times,
              weekday: sessionData.timeScheduleData.weekdayTimes,
            });
          }
          if (sessionData.timeScheduleData.weekendTimes) {
            state.setTimes({
              ...state.times,
              weekend: sessionData.timeScheduleData.weekendTimes,
            });
          }
        ...
        if (sessionData?.addressData?.addresses) {
          ...
          if (fromAddr) {
            ...
            state.setCoordinates((prev) => ({
              ...prev,
              from: fromAddr.coordinates,
            }));
          }
          if (toAddr) {
