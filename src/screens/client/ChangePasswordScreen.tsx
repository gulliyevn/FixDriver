...
import {
  ChangePasswordScreenStyles as styles,
  getChangePasswordScreenColors,
} from "../../styles/screens/profile/ChangePasswordScreen.styles";
import { ProfileService } from "../../services/ProfileService";

const ChangePasswordScreen: React.FC<ClientScreenProps<"ChangePassword">> = ({
  navigation,
}) => {
  ...
  return (
    ...
    >
      <View style={[styles.header, changePasswordColors.header]}>
        ...
        <Text style={[styles.title, changePasswordColors.title]}>
      ...
      >
        ...
        <View style={styles.inputContainer}>
          ...
          <View
            style={[styles.passwordInput, changePasswordColors.passwordInput]}
          >
            <TextInput
          ...
          {errors.currentPassword && (
            <Text style={[styles.errorText, changePasswordColors.errorText]}>
              {errors.currentPassword}
            </Text>
          )}
        </View>
        ...
        >
          <Text style={styles.submitButtonText}>
            {loading
              ? t("profile.settings.security.changingPassword")
              : t("profile.settings.security.changePassword")}
          </Text>
        </TouchableOpacity>
      </ScrollView>
