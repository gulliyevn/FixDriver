...
describe("Formatters", () => {
  ...
  describe("truncate", () => {
    it("truncates text correctly", () => {
      ...
      expect(truncate("Long text that needs truncation", 10)).toBe(
        "Long text ...",
      );
  ...
  describe("formatDateWithLanguage", () => {
    it("formats date with short format", () => {
      ...
      expect(formatDateWithLanguage(testDate, "ru", "short")).toBe(
        "15.01.2024",
      );
      expect(formatDateWithLanguage(testDate, "en", "short")).toBe(
        "01/15/2024",
      );
      expect(formatDateWithLanguage(testDate, "de", "short")).toBe(
        "15.01.2024",
      );
      expect(formatDateWithLanguage(testDate, "es", "short")).toBe(
        "15/01/2024",
      );
      expect(formatDateWithLanguage(testDate, "fr", "short")).toBe(
        "15/01/2024",
      );
      expect(formatDateWithLanguage(testDate, "tr", "short")).toBe(
        "15.01.2024",
      );
      expect(formatDateWithLanguage(testDate, "ar", "short")).toBe(
        "١٥‏/٠١‏/٢٠٢٤",
      ); // Arabic with RTL marks
      expect(formatDateWithLanguage(testDate, "az", "short")).toBe(
        "15.01.2024",
      );
    });
    ...
    it("formats date with long format", () => {
      ...
      expect(formatDateWithLanguage(testDate, "ru", "long")).toContain(
        "15 января 2024",
      );
      expect(formatDateWithLanguage(testDate, "en", "long")).toContain(
        "January 15, 2024",
      );
      expect(formatDateWithLanguage(testDate, "de", "long")).toContain(
        "15. Januar 2024",
      );
      expect(formatDateWithLanguage(testDate, "es", "long")).toContain(
        "15 de enero de 2024",
      );
      expect(formatDateWithLanguage(testDate, "fr", "long")).toContain(
        "15 janvier 2024",
      );
      expect(formatDateWithLanguage(testDate, "tr", "long")).toContain(
        "15 Ocak 2024",
      );
      expect(formatDateWithLanguage(testDate, "ar", "long")).toContain(
        "١٥ يناير ٢٠٢٤",
      );
      expect(formatDateWithLanguage(testDate, "az", "long")).toContain(
        "15 yanvar 2024",
      );
    });
