...
export const cardContainerWithDynamicWidth = (
  screenWidth: number,
): ViewStyle => ({
...
export const balanceCardWithTheme = (
  currentColors: { primary: string },
  isDark?: boolean,
): ViewStyle => ({
...
export const cardFrontButtonWithTheme = (
  cardBg: string,
  topUpBtnColor: string,
): ViewStyle => ({
...
export const cardFrontButton2WithTheme = (
  cardBg: string,
  cashbackBtnColor: string,
): ViewStyle => ({
  backgroundColor: cardBg,
...
export const modalContainerWithTheme = (currentColors: {
  card: string;
}): ViewStyle => ({
  backgroundColor: currentColors.card,
});

export const modalTitleWithTheme = (currentColors: {
  text: string;
}): TextStyle => ({
  color: currentColors.text,
});

export const modalLabelWithTheme = (currentColors: {
  textSecondary: string;
}): TextStyle => ({
  color: currentColors.textSecondary,
});

export const modalInputWithTheme = (currentColors: {
  border: string;
  text: string;
  surface: string;
}): ViewStyle & TextStyle => ({
...
export const modalPayBtnWithTheme = (currentColors: {
  primary: string;
}): ViewStyle => ({
  backgroundColor: currentColors.primary,
});

export const modalCancelBtnTextWithTheme = (currentColors: {
  textSecondary: string;
}): TextStyle => ({
  color: currentColors.textSecondary,
});
