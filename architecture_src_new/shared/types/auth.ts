...
// Утилиты для аутентификации - AUTO LOGOUT DISABLED
export const isTokenExpired = (expiresAt: string): boolean => {
  // Always return false to disable auto logout
  return false;
};

export const getTokenExpiryTime = (expiresIn: number): Date => {
  // Return far future date to disable auto logout
...
export const getSessionDuration = (createdAt: string, expiresAt: string): number => {
  // Return max duration to indicate no expiry
