...
export const ENV_CONFIG = {
  ...
  JWT: {
    ...
    // Token lifetime (should match backend) - DISABLED AUTO LOGOUT
    ACCESS_TOKEN_EXPIRY: 0, // 0 = no expiry (disabled auto logout)
    REFRESH_TOKEN_EXPIRY: 0, // 0 = no expiry (disabled auto logout)
  },
