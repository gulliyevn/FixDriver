...
import { createMapViewStyles } from '../styles/MapView.styles';
...
import MapMarkersComponent from './MapMarkers';
...
const MapViewComponent = forwardRef<MapRef, MapViewComponentProps>(({
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Дополнительные кнопки управления убраны - теперь в MapScreen */}
    </View>
  );
});
