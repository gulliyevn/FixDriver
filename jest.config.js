module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^expo-linear-gradient$': '<rootDir>/src/mocks/expoLinearGradientMock.ts',
    ...
    '^expo-status-bar$': '<rootDir>/src/mocks/expoStatusBarMock.ts',
    '^react-native-maps$': '<rootDir>/src/mocks/reactNativeMapsMock.ts',
    '^react-native-calendars$': '<rootDir>/src/mocks/reactNativeCalendarsMock.ts',
    '^react-native-card-scanner$': '<rootDir>/src/mocks/reactNativeCardScannerMock.ts',
    '^react-native-dropdown-picker$': '<rootDir>/src/mocks/reactNativeDropdownPickerMock.ts',
    '^react-native-gesture-handler$': '<rootDir>/src/mocks/reactNativeGestureHandlerMock.ts',
    ...
    '^react-native-screens$': '<rootDir>/src/mocks/reactNativeScreensMock.ts',
    '^react-native-svg$': '<rootDir>/src/mocks/reactNativeSvgMock.ts',
