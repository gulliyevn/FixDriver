...
import { driverAddressService as addressService, CreateAddressRequest, UpdateAddressRequest } from '../../services/driver/DriverAddressService';

interface DriverUseAddressesReturn {
  addresses: Address[];
  loading: boolean;
  error: string | null;
...
export const useDriverAddresses = (): DriverUseAddressesReturn => {
